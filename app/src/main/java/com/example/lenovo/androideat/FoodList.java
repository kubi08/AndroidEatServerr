...
import com.example.lenovo.ViewHolder.FoodViewHolder;
import com.example.lenovo.androideatserverr.Common.Common;
import com.example.lenovo.androideatserverr.Model.Category;
import com.example.lenovo.androideatserverr.Model.Food;
...
public class FoodList extends AppCompatActivity {
    ...
    private void showAddDialog() {
        ...
        alertDialog.setTitle("Yeni yiyecek ekleyiniz");
        alertDialog.setMessage("lütfen bilgilerinizi tam doldurunuz");
        ...
        alertDialog.setPositiveButton("Evet", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if(newFood !=null){
                    ...
                    Snackbar.make(rootLayout,"Yeni kategori"+newFood.getName()+"Eklendi",Snackbar.LENGTH_SHORT)
                            .show();
                }
            ...
            imageFolder.putFile(saveUri)
                    ...
                    .addOnProgressListener(new OnProgressListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onProgress(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            mDialog.setMessage("Yüklendi"+prgress+"%");
    ...
    private void chooseImage() {
        ...
        startActivityForResult(Intent.createChooser(intent,"Resim seçiniz"), Common.PICK_IMAGE_REQUEST);
    }
    ...
    private void showUpdateFoodDialog(final String key, final Food ıtem) {
        ...
        AlertDialog.Builder alertDialog=new AlertDialog.Builder(FoodList.this);
        alertDialog.setTitle("Yiyecek düzenle");
        alertDialog.setMessage("lütfen bilgilerinizi tam doldurunuz");
        ...
        alertDialog.setPositiveButton("Evet", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                dialog.dismiss();
                    ...
                    Snackbar.make(rootLayout,"Kategori"+ıtem.getName()+"Düzenlendi",Snackbar.LENGTH_SHORT)
                            .show();
