...
import com.example.lenovo.Service.ListenOrder;
import com.example.lenovo.ViewHolder.MenuViewHolder;
import com.example.lenovo.androideatserverr.Common.Common;
import com.example.lenovo.androideatserverr.Model.Category;
import com.example.lenovo.androideatserverr.OrderStatus;
...
public class Home extends AppCompatActivity
    ...
    private void showDialog() {
        ...
        alertDialog.setTitle("Yeni kategori ekleyiniz");
        ...
        alertDialog.setPositiveButton("Evet", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if(newCategory !=null){
                    ...
                    Snackbar.make(drawer,"Yeni kategori"+newCategory.getName()+"Eklendi",Snackbar.LENGTH_SHORT)
                            .show();
                }
