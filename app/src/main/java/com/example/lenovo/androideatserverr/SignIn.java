...
import com.example.lenovo.androideat.Home;
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
              if(dataSnapshot.child(localPhone).exists()){
                  ...
                  if(Boolean.parseBoolean(user.getIsStaff())){
                      ...
                      Toast.makeText(SignIn.this,"Lütfen hesabınızla giriş yapınız",Toast.LENGTH_SHORT).show();


              }
              else {
                  mDialog.dismiss();
                  Toast.makeText(SignIn.this,"Kullanıcı kayıtlı değil",Toast.LENGTH_SHORT).show();
              }
            }
